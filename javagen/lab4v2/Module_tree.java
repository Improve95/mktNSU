...
final public class Module_tree {
	public static final Object[] f_getTreeArrayValue(Struct atree, Object akey) {
		return ((Object[])Module_tree.f_lookupTreeDef(atree, akey, SingletonStructs.arr_empty));
	}
	...
	public static final Struct f_treePushToArrayValue(Struct atree, Object akey, Object avalue) {
		final Object[] l0_c = ((Object[])Module_tree.f_lookupTreeDef(atree, akey, SingletonStructs.arr_empty));
		return Module_tree.f_setTree(atree, akey, Module_array.f_arrayPush(l0_c, avalue));
	}
